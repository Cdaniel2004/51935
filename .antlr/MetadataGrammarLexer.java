...
public class MetadataGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "TEXTO", "NUMERO", "FECHA", "STRING_LITERAL", 
			"DIGIT", "LETTER", "CHAR", "WHITESPACE", "COMMENT"
		};
	}
	...
	public MetadataGrammarLexer(CharStream input) {
		super(input);
